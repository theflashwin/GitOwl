...
export default function Home() {
  ...
  return (
    <div>
      {loading ? <AnimatedLoader /> : <div className="relative w-full h-screen overflow-hidden bg-gradient-to-r from-blue-800 via-yellow-00 to-blue-800">
        <Navbar />
        ...
        <div className="absolute text-center inset-0 flex flex-col items-center justify-center z-10">
          ...
          <div className="flex space-x-4">
            <input
              ...
              className="px-4 py-3 w-96 rounded-lg border border-white bg-gray-700 text-white placeholder-gray-200 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            />
          ...
          >
            <div className="bg-gray-800 bg-opacity-75 backdrop-filter backdrop-blur-lg p-4 rounded-lg shadow-lg inline-block">
              <p className="text-gray-100 mb-2">🔑 This repository appears private. Please provide your GitHub API Key:</p>
              <input
                type="text"
